...
@app.route(route="checkitem", methods=["GET"])
def checkitem(req: func.HttpRequest) -> func.HttpResponse:
    logging.info('Python HTTP trigger function processed a request.')
...
register_route("checkitem", ["GET"])

@app.route(route="slotitem", methods=["GET"])
def slotitem(req: func.HttpRequest) -> func.HttpResponse:
    logging.info('Python HTTP trigger function processed a request.')
